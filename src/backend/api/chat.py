...
# Keywords that trigger preset save / list on the prediction dashboard
...
# Extract preset name + key=value features from messages like:
#   "save as a preset called 'Best Case': Region=East, Units=500"
#   "add a preset named Average Quarter with Region=Central Units=200 Product=Widget"
