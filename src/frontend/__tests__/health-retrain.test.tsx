...
jest.mock("../lib/api", () => ({
  api: {
    ...
    deploy: {
      ...
      getVersions: jest.fn().mockResolvedValue({ deployment_id: "dep1", current_version_number: 1, versions: [] }),
      rollback: jest.fn(),
      ...
      testWebhook: jest.fn(),
      sla: jest.fn().mockResolvedValue({ deployment_id: "dep1", sample_count: 0, p50_ms: null, p95_ms: null, p99_ms: null, avg_ms: null, alert: false, alert_message: null, latency_by_day: [] }),
    },
  },
}))
